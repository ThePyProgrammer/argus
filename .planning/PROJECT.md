...
- ✓ Repeatable CLI evaluation runner with JSONL/CSV exports, aggregate comparison table, metadata, baseline regression test, repaired command-schedule semantics, and enforced action-mode metadata/CLI contract — v4.0 Phases 4, 6 & 7
...
**Shipped:** v4.0 Benchmarkable Locomotion Environment completed on 2026-05-02 with the harness guide, controller-family comparison matrix, residual placeholder seam guards, repaired evaluation-runner command semantics, and enforced evaluation action-mode contract verified.
...
---
*Last updated: 2026-05-02 — v4.0 Phase 7 align-evaluation-action-mode-contract completed*
