...
class SkillStateEncoder:
    ...
    def encode(
        ...
        *,
        ...
        del overlap_score, idle_robot_count, connectivity_health, localization_health, map_quality_health
    ...
    def _summarize_frontiers(
        *,
        ...
        distances = [float(np.linalg.norm(np.asarray(frontier.centroid, dtype=float)[:2] - robot_xy)) for frontier in frontiers]
